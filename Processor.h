...
#define DECLARE_JUMP_(name, expression) \
    void cmd_##name##_();
...
uint32_t CProcessor::get_command_len_(const char* token_pos) const
{
...
void CProcessor::jump_helper_(EJumpMode mode, UWord arg)
{
    CRS_IF_GUARD(CRS_BEG_CHECK();)
