...
HANDLE_COMMAND_(ECommand::CMD_JMP, jmp, PARAM, "idx | reg | lbl")
HANDLE_COMMAND_(ECommand::CMD_JZ,  jz,  PARAM, "idx | reg | lbl")
HANDLE_COMMAND_(ECommand::CMD_JNZ, jnz, PARAM, "idx | reg | lbl")
HANDLE_COMMAND_(ECommand::CMD_JE,  je,  PARAM, "idx | reg | lbl")
HANDLE_COMMAND_(ECommand::CMD_JNE, jne, PARAM, "idx | reg | lbl")
HANDLE_COMMAND_(ECommand::CMD_JG,  jg,  PARAM, "idx | reg | lbl")
HANDLE_COMMAND_(ECommand::CMD_JGE, jge, PARAM, "idx | reg | lbl")
HANDLE_COMMAND_(ECommand::CMD_JL,  jl,  PARAM, "idx | reg | lbl")
HANDLE_COMMAND_(ECommand::CMD_JLE, jle, PARAM, "idx | reg | lbl")
